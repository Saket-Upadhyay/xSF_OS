...
$(kernel_object_files): build/kernel/%.o : source/kernel/%.c
	mkdir -p $(dir $@) && \
	x86_64-elf-gcc -c -I source/interface -ffreestanding $(patsubst build/kernel/%.o, source/kernel/%.c, $@) -o $@

$(x86_64_c_object_files): build/x86_64/%.o : source/x86_64/%.c
	mkdir -p $(dir $@) && \
	x86_64-elf-gcc -c -I source/interface -ffreestanding $(patsubst build/x86_64/%.o, source/x86_64/%.c, $@) -o $@
...
.PHONY: buildos
buildos: $(kernel_object_files) $(x86_64_object_files)
	mkdir -p dist/x86_64 && \
